...
pub async fn handle(
    ...
    let mut multiple_items = vec![
        ...
        (
            SvgText::new(463.5, 309.0 - 5.0, "ac"),
            text_option_40_0_center_normal,
        ),
        (
            SvgText::new(516., 462.0 - 5.0, "ac"),
            text_option_40_0_center_normal,
        ),
        (
        ...
        (
            SvgText::new(717.0 - 5.0, 407.5, "H1"),
    ...
    let specific_items = match params.thread_type {
        ThreadType::Male => vec![
            (
                SvgText::new(169.5, 322.5 - 5.0, "R1"),
                text_option_40_0_center_normal,
            ),
            (
                SvgText::new(356.5, 498. + 15.0, "R2"),
                text_option_40_0_start_normal,
            ),
            (
                SvgText::new(313.0 - 5.0, 419.0, "h3"),
                text_option_40_90_center_normal,
            ),
            (
            ...
            (
                SvgText::new(131.5 - 5.0, 630.5, "d3"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(212.0 - 5.0, 372.5, "z"),
                text_option_40_90_center_normal,
            ),
        ],
        ThreadType::Female => vec![
            (
                SvgText::new(820.5 - 5.0, 407.5, "H4"),
                text_option_40_90_center_normal,
            ),
            (
            ...
            (
                SvgText::new(780.0, 309.0 - 5.0, "R1"),
                text_option_40_0_center_normal,
            ),
            (
                SvgText::new(770.0, 497.5 + 15.0, "R2"),
                text_option_40_0_start_normal,
            ),
        ],
    };
