...
pub async fn handle(
    ...
    let text_option_40_90_center_normal = svg_service.create_custom_text_options(
        40.0,
        -90.0,
        TextAnchor::Middle,
        FontWeight::Normal,
    ...
    let mut multiple_items = vec![
        ...
        (
            SvgText::new(414.5, 624.5 - 5.0, "P"),
            text_option_40_0_center_normal,
        ),
        (
            SvgText::new(717.0 - 5.0, 407.5, "H"),
    ...
    let specific_items = match params.thread_type {
        ThreadType::Male => vec![
            (
                SvgText::new(37.0 - 5.0, 555.0, "d"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(81.0 - 5.0, 590.0, "d2"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(131.5 - 5.0, 630.5, "d1"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(212.0 - 5.0, 372.5, "h3"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(169.5, 322.5 - 5.0, "H/4"),
                text_option_40_0_center_normal,
            ),
            (
                SvgText::new(356.5, 498. + 15.0, "H/8"),
                text_option_40_0_start_normal,
            ),
        ],
        ThreadType::Female => vec![
            (
                SvgText::new(917.0 - 5.0, 621.5, "D1"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(973. - 5.0, 589.5, "D2"),
                text_option_40_90_center_normal,
            ),
            (
                SvgText::new(1035. - 5.0, 545.5, "D"),
                text_option_40_90_center_normal,
            ),
            (
            ...
            (
                SvgText::new(780.0, 309.0 - 5.0, "H/4"),
                text_option_40_0_center_normal,
            ),
            (
                SvgText::new(770.0, 497.5 + 15.0, "H/8"),
                text_option_40_0_start_normal,
            ),
        ],
    };
