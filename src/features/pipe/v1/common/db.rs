...
use crate::{
    features::pipe::v1::common::models::{ModelPipeDiameterBasic, ModelPipeOtherDimensions, ModelPipeTolerance},
...
pub struct ThreadData {
    pub basic_diameters: ModelPipeDiameterBasic,
    pub tolerances: ModelPipeTolerance,
    pub other_dimensions: ModelPipeOtherDimensions,
}
...
impl ThreadDataService {
    ...
    pub async fn fetch_thread_data(
        ...
        let main_query = "SELECT * FROM pipe.main WHERE diameter = $1::integer AND pitch = $2::double precision";
        let basic_dim_query = "SELECT * FROM pipe.basic_dimensions WHERE p = $1::double precision";
    ...
    fn extract_basic_diameters(
        ...
        diameter: i32,
    ) -> Result<ModelPipeDiameterBasic, sqlx::Error> {
        Ok(ModelPipeDiameterBasic {
            d: diameter as f64,
    ...
    fn extract_basic_dimensions(&self, row: &sqlx::postgres::PgRow) -> Result<ModelPipeOtherDimensions, sqlx::Error> {
        Ok(ModelPipeOtherDimensions {
